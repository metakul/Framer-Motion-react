...
const MetakulCollection = () => {
  return (
    <main class="pt-[3.5rem] lg:pt-8">
      ...
      <section class="relative bg-jacarta-800 pb-12 pt-28 dark:bg-jacarta-800">
        ...
        <div class="container">
          <div class="text-center">
            <h2 class="mb-2 font-display text-4xl font-medium  dark:text-white">Metakul NFT Collection</h2>
            <div class="mb-8">
              <span class="text-sm font-bold text-jacarta-400">Created by </span>
              <a href="https://www.linkedin.com/in/shubham-kunwar-90ba441ba/" target="_balnk" class="text-sm font-bold text-accent">Kunwar.eth</a>
            </div>

            <div
              class="mb-8 inline-flex flex-wrap items-center justify-center rounded-xl border border-jacarta-100 bg-jacarta-800 dark:border-jacarta-600 dark:bg-jacarta-800"
            >
              <a
                href="#"
                class="w-1/2 rounded-l-xl border-r border-jacarta-100 py-4 hover:shadow-md dark:border-jacarta-600 sm:w-32"
              >
                <div class="mb-1 text-base font-bold  dark:text-white">777</div>
                <div class="text-2xs font-medium tracking-tight dark:text-jacarta-400">Items</div>
              </a>
              <a
                href="#"
                class="w-1/2 border-jacarta-100 py-4 hover:shadow-md dark:border-jacarta-600 sm:w-32 sm:border-r"
              >
              ...
              >
                <div
                  class="mb-1 flex items-center justify-center text-base font-medium  dark:text-white"
                >
                ...
                <div class="text-2xs font-medium tracking-tight dark:text-jacarta-400">Floor Price</div>
              </a>
            ...
            <div class="mt-6 flex items-center justify-center space-x-2.5">
              ...
              >
                ...
                <div
                  class="dropdown-menu dropdown-menu-end z-10 hidden min-w-[200px] whitespace-nowrap rounded-xl bg-jacarta-800 py-4 px-2 text-left shadow-xl dark:bg-jacarta-800"
      ...
      <section class="relative py-12">
        ...
        <div class="container">
          <ul
            class="nav nav-tabs mb-6 flex items-center justify-center border-b border-jacarta-100 dark:border-jacarta-600"
            role="tablist"
          >
          
            <li class="nav-item" role="presentation">
              <button
                class="nav-link relative flex items-center whitespace-nowrap py-3 px-6 text-jacarta-400 hover: dark:hover:text-white"
                id="activity-tab"
                data-bs-toggle="tab"
              ...
              >
                ...
                <span class="font-display text-base font-medium">All NFTs</span>
              </button>
            </li>
          </ul>
          ...
          <div class="tab-content">
            <div class="tab-pane fade show active" id="items" role="tabpanel" aria-labelledby="items-tab">
              <div class="mb-8 flex flex-wrap items-center justify-between">
                <div class="flex flex-wrap items-center">
                  <div class="my-1 mr-2.5">
                    <button
                      class="dropdown-toggle group group flex h-9 items-center rounded-lg border border-jacarta-100 bg-jacarta-800 px-4 font-display text-sm font-semibold  transition-colors hover:border-transparent hover:bg-accent hover:text-white dark:border-jacarta-600 dark:bg-jacarta-700 dark:text-white dark:hover:bg-accent"
                      id="blockchainFilter"
                      data-bs-toggle="dropdown"
                      aria-expanded="false"
                    >
                      <svg
                        ...
                        width="24"
                        height="24"
                        class="mr-1 h-4 w-4 fill-jacarta-300 transition-colors group-hover:fill-white dark:fill-jacarta-100"
                      >
                        <path fill="none" d="M0 0h24v24H0z" />
                        <path
              ...
              <div class="grid grid-cols-1 gap-[1.875rem] md:grid-cols-2 lg:grid-cols-4">
                ...
                <article>
                  <div
                    class="block rounded-2.5xl border border-jacarta-100 bg-jacarta-800 p-[1.1875rem] transition-shadow hover:shadow-lg dark:border-jacarta-700 dark:bg-jacarta-700"
                  >
                    <figure class="relative">
                      <a href="item.html">
                        <img
                      ...
                      <div
                        class="absolute top-3 right-3 flex items-center space-x-1 rounded-md bg-jacarta-800 p-2 dark:bg-jacarta-700"
                      >
                        <span
                    ...
                    <div class="mt-7 flex items-center justify-between">
                      <a href="item.html">
                        <span class="font-display text-base  hover:text-accent dark:text-white"
                    ...
                    <div class="mt-2 text-sm">
                      <span class="mr-1  dark:text-jacarta-200">From 5.9 ETH</span>
