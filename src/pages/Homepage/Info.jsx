  ...
  >
      <section className="relative py-6 lg:py-6">
        ...
        <div className="container mt-20 lg:pb-32">
          ...
          <p className="p-4 mt-10 mb-10    max-w-4xl text-2xl font-medium  lg:ml-36">
          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4 lg:ml-36">
            ...
            <div>
              ...
              <span className="text-lg ">Already Minted</span>
            </div>
            <div>
              <div>
                <span
            ...
            <div>
              ...
              <span className="text-lg ">NFT Utilities</span>
            </div>
          </div>
        </div>
        ...
        <div className="container pt-12">
          <div className="items-center justify-between lg:flex">
            ...
            <div className="lg:w-[45%] lg:pl-16">
              ...
              <a
                href="metakul"
                className="inline-block rounded-full bg-accent py-3 px-8 text-center font-semibold  shadow-accent-volume transition-all hover:bg-accent-dark"
              >
                Come Discover
              </a>
            </div>
      ...
      <section className=" py-6 lg:pb-16 bottom-2 border-left border-top rounded-2xl ">
